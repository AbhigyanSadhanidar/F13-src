    ...
    <v-row justify="center" align="center">
      ...
      <v-col cols="12" sm="12" md="8">
        <v-card class="mb-5 elevation-0">
          <v-card-title class="justify-center font-weight-bold orange--text text-h4">
            Letters Of Appreciations
          </v-card-title>
          <v-card-text>
            <v-row align="center" justify="center">
              <v-col cols="12" sm="12" md="4">
                  <letter-slider title="Appreciation" path="appreciation" length=1 actual=1 />
              </v-col>

              <v-col cols="12" sm="12" md="4">
                  <letter-slider title="Appreciation" path="partner" length=6 actual=6 />
              </v-col>

              <v-col cols="12" sm="12" md="4">
                  <letter-slider title="Appreciation" path="recommendation" length=8 actual=30 />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
